...
qc_primes, groups, good_primes := 
               find_qc_primes(X : mws_primes_bound := 5000, qc_primes_bound := 100, number_of_bad_disks := 1, inf_modp_allowed := false,
...
// [ 5, 13, 23, 29, 37, 41, 43, 47, 53, 67, 79, 97, 107, 139, 149, 151, 179, 181, 197 ]
// 37, 43 work
// 47, 53: Runtime error in 'Curve': No appropriate curve found
// 67: 840 cosets remaining after v=10589
// 79: 0 cosets remaining after v=4177
// 97: 860 cosets remaining after v=16831
